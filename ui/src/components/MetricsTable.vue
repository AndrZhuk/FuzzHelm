...
const META: Record<string, { uk: string; kind: Kind; hint?: string }> = {
  ...
  psr:            { uk: 'PSR', kind: 'ratio', hint: 'ймовірнісний коефіцієнт Шарпа' },
  ...
  var95:          { uk: 'VaR 95 %', kind: 'money' },
  cvar95:         { uk: 'CVaR 95 %', kind: 'money' },
  ...
  skew:           { uk: 'Асиметрія', kind: 'ratio' },
  kurt:           { uk: 'Ексцес', kind: 'ratio' },
  tail_ratio:     { uk: 'Хвостове відношення', kind: 'ratio' },
  sr_period:      { uk: 'Шарп за період', kind: 'ratio' },
  n_obs:          { uk: 'Спостережень', kind: 'count' },
